 ...
 */
public class MovieProvider extends AbstractAddGetContentProvider {
   
	public static final String AUTHORITY = "com.movie.database.MovieProvider";
    public static final String DICTIONARY_NAME = "movies";
	...
	public String getTableName() {
		return MovieDatabase.MOVIES_TABLE_NAME;
	}
	...
	protected Cursor getEntity(String[] selectionArgs) {
		return mDictionary.getMovie(selectionArgs, null);
	}
	@Override
